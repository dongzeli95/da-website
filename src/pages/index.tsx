...
const IndexPage: NextPage = () => {
  return (
    <div>
      <Head>
        <title>DA Chat - Chat-based Data Analysis client for the next decade</title>
        {/* <link rel="icon" href="/chat-logo-bot.webp" /> */}
        <meta name="description" content="DA Chat - Chat-based Data Analysis client for the next decade" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="og:title" property="og:title" content="DA Chat" />
        <meta name="og:description" property="og:description" content="DA Chat - Chat-based Data Analysis client for the next decade" />
