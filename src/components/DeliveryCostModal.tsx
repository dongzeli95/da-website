...
const DeliveryCostModal = (props: Props) => {
  ...
  const handleEstimate = async () => {
    ...
    try {
      // Here you would make your API request to save the delivery cost.
      // e.g., await api.saveDeliveryCost(deliveryCost);
      let conversation = conversationStore.currentConversation;
        if (!conversation) {
            return;
        }
      ...
      console.log("submitted Delivery cost: ", deliveryCost)
